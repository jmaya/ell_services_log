# RailsAdmin config file. Generated on September 27, 2012 10:07
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ell Services Log', 'Admin']
  ...
  # config.excluded_models = ['Category', 'Entry', 'EntryTask', 'Student', 'Task', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Entry', 'EntryTask', 'Student', 'Task', 'User']
  ...
  #     configure :entry_tasks, :has_many_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :date_of_service, :date 
  #     configure :duration_of_service, :integer 
  #     configure :group_size, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  # config.model 'EntryTask' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your entry_task.rb model definition
  ...
  #     configure :group_taggings, :has_many_association         # Hidden 
  #     configure :groups, :has_many_association         # Hidden 
  ...
  #     configure :language_classification, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
